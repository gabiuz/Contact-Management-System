<x-admin-layout>
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      <h2 class="text-2xl font-semibold text-gray-900">Sales Rep</h2>
      <div class="relative">
        <input
          type="text"
          placeholder="Search"
      ...
      <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
        ...
        <div class="flex items-center gap-2 absolute left-1/2 -translate-x-1/2">
          ...
          <div class="flex gap-1">
            ...
            <button class="px-3 py-1.5 text-sm text-gray-700 hover:bg-gray-100 rounded transition-colors duration-200">2</button>
        ...
        <table class="w-full border-collapse">
          <thead class="bg-violet-100">
            <tr class="border-8 border-violet-100 border-b-white">
              ...
              <th class="px-6 py-3 text-center text-sm font-bold text-gray-600">Action</th>
            </tr>
          </thead>
          <tbody>
            <tr class="bg-violet-50 border-8 border-white">
              ...
              <td class="px-6 py-4 text-sm text-center text-slate-500">jnsi@gmail.com</td>
              <td class="px-6 py-4 text-sm text-center">
                <div class="flex items-center justify-center gap-2">
                  <button onclick="openEditSalesRepModal({
                      firstName: 'Jedia',
                      middleName: 'Jedia',
                      lastName: 'Sagun',
                      email: 'jnsi@gmail.com'
                  ...
                  <button onclick="openDeleteConfirmModal(1)" class="p-1.5 text-red-600 hover:bg-red-50 rounded transition-colors duration-200">
                    <svg width="30" height="30" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path opacity="0.4" d="M5.94338 7.15L6.75807 18.15H15.2418L16.0565 7.15H5.93994H5.94338Z" fill="#FF0004" />
                      <path d="M8.25005 1.65H13.75L14.575 3.85H18.7V5.5H3.30005V3.85H7.42505L8.25005 1.65ZM5.22505 19.8L4.28661 7.15H5.94005L6.75474 18.15H15.2385L16.0532 7.15H17.7066L16.7682 19.8H5.21817H5.22505Z" fill="#FF0004" />
                    </svg>
