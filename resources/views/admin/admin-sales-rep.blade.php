          ...
          <tbody>
            @forelse ($representatives as $rep)
              <tr class="bg-violet-50 border-8 border-white">
                <td class="px-6 py-4 text-sm text-center text-slate-500">{{ $rep->representative_id }}</td>
                <td class="px-6 py-4 text-sm text-center text-slate-500">{{ $rep->first_name }}</td>
                <td class="px-6 py-4 text-sm text-center text-slate-500">{{ $rep->middle_name }}</td>
                <td class="px-6 py-4 text-sm text-center text-slate-500">{{ $rep->last_name }}</td>
                <td class="px-6 py-4 text-sm text-center text-slate-500">{{ $rep->email }}</td>
