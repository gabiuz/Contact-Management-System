<x-admin-layout>
      ...
      <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex items-start justify-between">
          <div>
            ...
            <h3 class="text-4xl font-bold text-gray-900">4</h3>
            <div class="flex items-center gap-1 mt-3">
              <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M19.7249 7.41602L22.548 10.2465L16.5319 16.2783L11.6006 11.3342L2.46533 20.5055L4.20361 22.2483L11.6006 14.8322L16.5319 19.7763L24.2987 12.0017L27.1218 14.8322V7.41602H19.7249Z" fill="#00B69B" />
              </svg>
      ...
      <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex items-center justify-between">
          <div>
            ...
            <h3 class="text-3xl font-bold text-gray-900">Reynard Rabanal</h3>
          </div>
          <svg width="76" height="76" viewBox="0 0 76 76" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path opacity="0.21" d="M53 0C65.7025 0 76 10.2975 76 23V53C76 65.7025 65.7025 76 53 76H23C10.2975 76 3.2215e-07 65.7025 0 53V23C0 10.2975 10.2975 3.22129e-07 23 0H53Z" fill="#3888FB" />
            <path d="M24.2073 51.7927H53.7629C54.8511 51.7927 55.7333 52.6748 55.7333 53.763C55.7333 54.8512 54.8511 55.7334 53.7629 55.7334H22.237C21.1488 55.7334 20.2666 54.8512 20.2666 53.763V22.2371C20.2666 21.1489 21.1488 20.2667 22.237 20.2667C23.3252 20.2667 24.2073 21.1489 24.2073 22.2371V51.7927Z" fill="#3888FB" />
            <path opacity="0.5" d="M31.556 43.2883C30.8118 44.0822 29.5648 44.1224 28.771 43.3782C27.9771 42.6339 27.9368 41.387 28.6811 40.5931L36.07 32.7116C36.7898 31.9438 37.9859 31.8772 38.7865 32.5604L44.6182 37.5368L52.2165 27.9124C52.8908 27.0583 54.1298 26.9125 54.9839 27.5868C55.8381 28.2611 55.9838 29.5001 55.3095 30.3542L46.4429 41.5853C45.7503 42.4626 44.4675 42.5887 43.6173 41.8632L37.6588 36.7787L31.556 43.2883Z" fill="#3888FB" />
          </svg>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex items-center justify-between">
          <div>
            ...
            <h3 class="text-3xl font-bold text-gray-900">Gabriel Nicolai Pelagio</h3>
          </div>
          <svg width="76" height="76" viewBox="0 0 76 76" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path opacity="0.21" d="M53 0C65.7025 0 76 10.2975 76 23V53C76 65.7025 65.7025 76 53 76H23C10.2975 76 3.2215e-07 65.7025 0 53V23C0 10.2975 10.2975 3.22129e-07 23 0H53Z" fill="#3888FB" />
            <path d="M24.2073 51.7927H53.7629C54.8511 51.7927 55.7333 52.6748 55.7333 53.763C55.7333 54.8512 54.8511 55.7334 53.7629 55.7334H22.237C21.1488 55.7334 20.2666 54.8512 20.2666 53.763V22.2371C20.2666 21.1489 21.1488 20.2667 22.237 20.2667C23.3252 20.2667 24.2073 21.1489 24.2073 22.2371V51.7927Z" fill="#3888FB" />
        ...
        <div class="flex items-center justify-center">
          ...
          <div class="ml-8 space-y-3">
            <div class="flex items-center gap-3">
              ...
              <span class="text-sm text-gray-700">Gianne</span>
              <span class="text-sm font-semibold text-gray-900 ml-auto">120</span>
            </div>
            <div class="flex items-center gap-3">
              <span class="w-3 h-3 rounded-full bg-gray-600"></span>
              <span class="text-sm text-gray-700">Reynard</span>
              <span class="text-sm font-semibold text-gray-900 ml-auto">76</span>
            </div>
            <div class="flex items-center gap-3">
              <span class="w-3 h-3 rounded-full bg-blue-400"></span>
              <span class="text-sm text-gray-700">Gabriel</span>
              <span class="text-sm font-semibold text-gray-900 ml-auto">67</span>
            </div>
            <div class="flex items-center gap-3">
              <span class="w-3 h-3 rounded-full bg-blue-600"></span>
              <span class="text-sm text-gray-700">Jedia</span>
              <span class="text-sm font-semibold text-gray-900 ml-auto">25</span>
            </div>
          </div>
        </div>
      </div>
  ...
  <script>
    ...
    const gianneGradient = clientsPerRepCtx.createLinearGradient(0, 0, 0, 400);
    gianneGradient.addColorStop(0, '#1f2937');
    gianneGradient.addColorStop(1, '#4b5563');

    const reynardGradient = clientsPerRepCtx.createLinearGradient(0, 0, 0, 400);
    reynardGradient.addColorStop(0, '#3b82f6');
    reynardGradient.addColorStop(1, '#93c5fd');

    const cabrielGradient = clientsPerRepCtx.createLinearGradient(0, 0, 0, 400);
    cabrielGradient.addColorStop(0, '#1e40af');
    cabrielGradient.addColorStop(1, '#60a5fa');

    const jediaGradient = clientsPerRepCtx.createLinearGradient(0, 0, 0, 400);
    jediaGradient.addColorStop(0, '#93c5fd');
    jediaGradient.addColorStop(1, '#dbeafe');

    new Chart(clientsPerRepCtx, {
      type: 'doughnut',
      data: {
        labels: ['Gianne', 'Reynard', 'Cabriel', 'Jedia'],
        datasets: [{
          data: [120, 76, 67, 25],
          backgroundColor: [gianneGradient, reynardGradient, cabrielGradient, jediaGradient],
          borderWidth: 4,
          borderColor: '#ffffff',
          cutout: '55%',
          spacing: 2,
