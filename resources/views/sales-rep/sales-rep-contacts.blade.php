<x-sales-rep-layout>
    <div class="space-y-6">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <h2 class="text-xl sm:text-2xl font-semibold text-gray-900">Contacts</h2>
            <div class="relative">
                ...
                <table class="w-full border-collapse">
                    <thead class="bg-violet-100">
                        <tr class=" border-8 border-violet-100 border-b-white">
                            ...
                            <th class="px-3 sm:px-6 py-3 text-center text-xs sm:text-sm font-bold text-gray-600">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
    ...
    <x-add-contact-modal :representatives="$representatives" :action="route('sales-rep-contacts.store')" />
